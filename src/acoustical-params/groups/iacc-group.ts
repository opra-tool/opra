...
import { EARLY_IACC_PARAMETER, IACC_PARAMETER } from '../params/iacc';
...
export const IACC_GROUP: AcousticalParamGroupDefinition = {
  id: 'iacc',
  params: [IACC_PARAMETER, EARLY_IACC_PARAMETER],
